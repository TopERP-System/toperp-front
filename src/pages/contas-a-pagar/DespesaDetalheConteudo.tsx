...
import { HistoricoPagamentosConta } from "@/components/financeiro/HistoricoPagamentosConta";
import {
  formatarDataBR,
  ...
  return (
    <div className="space-y-6">
      ...
      <HistoricoPagamentosConta
        contaId={conta.id}
        titulo="Histórico de Pagamentos / Estornos"
        itens={detalhe?.historico_pagamentos}
        fallback={historico}
        labelAtivo="Pago"
        permiteEstorno={!conta.pedido_id}
      />
    </div>
  );
}
